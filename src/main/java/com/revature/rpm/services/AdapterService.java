...
/**
 * This service is meant to accept the DTO from the AWS SQS Message Queue and return a
 * notification of the appropriate type. At the moment, you need to determine the format externally.
 * @author ChrisTroll
 */
